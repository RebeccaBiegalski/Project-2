...
var wobbleSpeed = 10, wobbleDist = 0.10;

Dog.prototype.act = function(step) {
  this.wobble += step * wobbleSpeed;
  var wobblePos = Math.sin(this.wobble) * wobbleDist;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
};
...
Cat.prototype.act = function(step) {
  this.wobble += step * wobbleSpeed;
  var wobblePos = Math.sin(this.wobble) * wobbleDist;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
};
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  if ((type == "water" || type == "alien") && (this.status == null || this.status == "color" || this.status == "colors")) {
    this.status = "lost";
    this.finishDelay = 1;
  }
  else if (type == "coin") {
